...
class Message {
    ...
    public String toString() {
        return "Sender: " + sender + " Message: " + message + " Time: " + date_time;
    }
...
class Channel {
    ...
    @Override
    public String toString() {
        return "Channel name: " + name + " Channel id: " + id + " Channel type: " + type;
    }
    @Override
    public int hashCode() {
        return id.hashCode();
...
class Member {
    ...
    @Override
    public String toString() {
        return "Member email: " + email + " Member name: " + first_name + " " + last_name;
    }
    @Override
    public int hashCode() {
        return id.hashCode();
